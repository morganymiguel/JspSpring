...
<nav class="navbar navbar-dark sticky-top flex-md-nowrap w-100 p-0 border border-secondary">
  ...
  <ul class="nav px-3 col">
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/alba/albaList.do">알바목록</a>
    </li>
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/alba/albaInsert.do">알바등록</a>
    </li>
  </ul>
</nav>
