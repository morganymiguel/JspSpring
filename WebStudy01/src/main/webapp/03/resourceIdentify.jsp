...
<pre>
	...
	1. File System Resource: 파일시스템의 특정 드라이브 아래. (하드 아래) 파일시스템 절대 경로 형태(드라이브 루트부터 시작)
		D:\contents\images\cat1.jpg
	
	2. Class path REsource: classpath 아래. classpath이후의 qualified name 형태 접근. (classpath .)
		...
		%>
		--> <%=cpPath %>
	3. Web Resource: Web, URL 형태 접근.(ip address로 부터)
	...
	***웹상의 자원을 식별하기 위한 주소 체계
	URI : Unified Resource Identifier; 공용자원을 식별하는 자원
	URL : Unified Resource Locator; 주소를 통해서 식별한다.
